...
class BC_API blockchain_cert
    : public base_primary<blockchain_cert>
{
public:
    typedef std::vector<blockchain_cert> list;

    blockchain_cert();
    blockchain_cert(uint32_t version, const output_point& tx_point,
    ...
    const asset_cert& get_cert() const;
    void set_cert(const asset_cert& cert_);

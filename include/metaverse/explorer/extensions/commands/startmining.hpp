...
public:
    ...
    options_metadata& load_options() override
    {
        ...
        (
            ...
            "The mining target did/address. Defaults to empty, means a new address will be generated."
        )
        (
            "number,n",
        ...
        (
            ...
            "Accept block with the specified consensus, eg. pow, dpos, any, defaults to pow."
        );
